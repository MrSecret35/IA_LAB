...
ric_prof_lim_portale(S,0,[],_,S,G,G,_,GE,GE).
...
scriviCammino2(S,[Az|ListaAzioni],Ghiaccio,GhiaccioFinale,Gemme):-
    write("Posizione: "),write(S),write("\n"),
    write("Ghiaccio: "),write(Ghiaccio),write("\n"),
    write("Gemme: "),write(Gemme),write("\n"),
    write("\n"),
    ...
    scriviCammino2(SNuovo,ListaAzioni,GhiaccioN,GhiaccioFinale,Gemme).

scriviCammino2(S,[],Ghiaccio,Ghiaccio,Gemme):-
    write("Posizione: "),write(S),write("\n"),
    write("Ghiaccio: "),write(Ghiaccio),write("\n"),
    write("Gemme: "),write(Gemme),write("\n"),
    write("\n").